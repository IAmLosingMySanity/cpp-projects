...
int main() {
    std::unique_ptr<PassengerCarrier> airplane = std::make_unique<Airplane>("FlexAir");
    airplane->addPassenger(1);
    airplane->addPassenger(2);
    airplane->printPassengerList();
    
    std::unique_ptr<PassengerCarrier> train = std::make_unique<Train>("ExpressTrain");
    train->addPassenger(3);
    train->addPassenger(4);
    train->printPassengerList();
    
    std::unique_ptr<PassengerCarrier> car = std::make_unique<Car>("FamilyCar");
    car->addPassenger(5);
    car->addPassenger(6);
